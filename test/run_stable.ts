...
const tests = [
  "test/item29_cid_identity_chain_oracle.ts",
  "test/item31_cid_identity_chain_mcp.ts",
  "test/item30_semantic_snapshot_audit_mutations.ts",
  "test/item30_semantic_snapshot_audit_integration.ts",
  "test/item2_timeout_orphan.ts",
  "test/item33_parent_guard_inheritance.ts",
  "test/item3_stale_facts.ts",
  "test/item4_linemap_sidecar.ts",
  "test/item6_crash_triage.ts",
  "test/item8_symbol_diff_compare.ts",
  "test/item10_crash_triage.ts",
  ...
  "test/item37_lsp_artifact_receipt.ts",
  ...
  "test/item25_darwin_system_link_determinism.ts",
  "test/item25_current_parser_receipt_ingress.ts",
  "test/item25_ebnf_parser_node_map.ts",
  "test/item26_grammar_corpus_span.ts",
  "test/item27_mutation_net.ts",
  "test/item28_current_official_seven_stage_runner.ts",
  "test/item28_official_release_required.ts",
  "test/item34_current_release_green_audit.ts",
  "test/item38_tree_quiesce_probe.ts",
  "test/item39_driver_frontier_probe.ts",
  "test/item40_fusion_source_drift_guard.ts",
  "test/item41_current_schema_singleton.ts",
];
